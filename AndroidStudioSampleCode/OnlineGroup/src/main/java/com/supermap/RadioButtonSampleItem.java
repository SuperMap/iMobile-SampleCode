...
public class RadioButtonSampleItem extends AbstractItem<RadioButtonSampleItem, RadioButtonSampleItem.ViewHolder> {
    ...
    public RadioButtonSampleItem withUserId(String userId) {
        this.userId = new StringHolder(userId);
        return this;
    }

    public RadioButtonSampleItem withDataId(String dataId) {
        this.dataId = new StringHolder(dataId);
        return this;
    }

    public RadioButtonSampleItem withFilePath(String filePath) {
        this.filePath = new StringHolder(filePath);
        return this;
    }

    public RadioButtonSampleItem withResourceSharer(String resourceSharer) {
        this.resourceSharer = new StringHolder(resourceSharer);
        return this;
    }

    public RadioButtonSampleItem withCreator(String creator) {
        this.creator = new StringHolder(creator);
        return this;
    }

    public RadioButtonSampleItem withGroupId(String groupId) {
