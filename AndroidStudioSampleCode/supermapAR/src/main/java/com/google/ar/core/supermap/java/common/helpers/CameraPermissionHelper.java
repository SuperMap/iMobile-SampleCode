 ...
 */
package com.google.ar.core.supermap.java.common.helpers;
...
public final class CameraPermissionHelper {
  ...
  public static void requestCameraPermission(Activity activity) {
    ActivityCompat.requestPermissions(
        activity, new String[] {CAMERA_PERMISSION,READ_PHONE_STATE_PERMISSION,CHANGE_WIFI_STATE,MOUNT_UNMOUNT_FILESYSTEMS,ACCESS_WIFI_STATE,WRITE_EXTERNAL_STORAGE,ACCESS_FINE_LOCATION,ACCESS_NETWORK_STATE}, CAMERA_PERMISSION_CODE);
  }
