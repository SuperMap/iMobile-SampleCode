package com.supermap.ar.apparmap.bigdata;
 ...
 * 项目属性配置类
 */
public class PropertiesBigData {
    // 基础数据路径
    public static final String LICENSE_PATH = "/SuperMap/License/";            // 许可证位置

    public static final String DATA_PATH = "/SuperMap/ARdata/ChengduNewBigData/";     // 数据存放位置

    public static final String LOG_PATH = "/SuperMap/ARdata/ChengduNew/log";   // 日志存放位置
...
//    public static final String MAP_NAME = "MapClip_tmp";                           // 地图名称

    public static final String MAP_INDEX = "1";                                // 地图索引ID

    public static final String MAP_CENTER = "104.05863517384164,30.555540082577924";   // 地图中心点
    // 104.06053619247173,30.603989302011158
    ...
    // 小车模型相关
    public static final String DATASOURCE_CAR_NAME = "ex1";                    // 小车行进路线数据源
