...
public class MainActivity extends ListActivity {
    ...
    String[] arr={"试用许可","正式许可(自动激活归还)","正式许可(手动激活归还)","公有云许可","私有云许可","教育许可"};
    Class<?>[] samples={TrailLicenseActivity.class,OfficialLicenseActivity.class,OfficialLicense2Activity.class,CloudLicenseActivity.class,PrivateLicenseActivity.class,EduLicenseActivity.class};
