...
public class MyInsightsAdapter extends BaseAdapter {

    private ArrayList<InsightBaseBean> mList = new ArrayList();
    private Context mContext = null;
    private LayoutInflater mLayoutInflater = null;

    public MyInsightsAdapter(Context context, InsightsBean insightsBean) {
        mContext = context;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = mLayoutInflater.inflate(R.layout.item_myinsights_listview, null);
