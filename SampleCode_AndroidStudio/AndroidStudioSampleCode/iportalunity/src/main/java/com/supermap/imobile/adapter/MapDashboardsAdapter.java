...
public class MapDashboardsAdapter extends BaseAdapter {

    private ArrayList<MapDashboardBaseBean> mList = new ArrayList();
    private Context mContext = null;
    private LayoutInflater mLayoutInflater = null;

    public MapDashboardsAdapter(Context context, MyMapDashboards myMapDashboards) {
        mContext = context;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = mLayoutInflater.inflate(R.layout.item_mapdashboard_listview, null);
