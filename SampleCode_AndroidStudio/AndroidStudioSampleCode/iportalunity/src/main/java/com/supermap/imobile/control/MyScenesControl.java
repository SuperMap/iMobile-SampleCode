...
import com.supermap.imobile.adapter.MyScenesAdapter;
 ...
 * 我的场景
 */
public class MyScenesControl {
    private static final String TAG = "MyScenesControl";

    private MainActivity mMainActivity = null;
    private ListView mListView = null;
    private PullToRefreshView mPullToRefreshView;
    private MyScenesAdapter adapter = null;

    public MyScenesControl(Context context, ListView listView, PullToRefreshView pullToRefreshView) {
    ...
    private OnResponseListener listener = new OnResponseListener() {
        ...
        public void onResponse(final Response response) {
            ...
            if (adapter == null) {
                adapter = new MyScenesAdapter(mMainActivity, scenesBean);
            } else {
