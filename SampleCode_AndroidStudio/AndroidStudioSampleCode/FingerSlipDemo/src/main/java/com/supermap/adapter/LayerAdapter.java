    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        viewHolder.tv_layername.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                else  if (layerList.get(position).getDataset().getType()== DatasetType.GRID){
                    layerList.get(position).setEditable(true);
                    mainActivity.showGridStyleFragment();
                }
                else  if (layerList.get(position).getDataset().getType()== DatasetType.TEXT){
                    layerList.get(position).setEditable(true);
                    mainActivity.showTextStyleFragment();
                }}
                else  {
