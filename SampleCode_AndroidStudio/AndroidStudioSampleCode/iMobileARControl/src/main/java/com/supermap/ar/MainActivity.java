 ...
 *       ArControl2.setARMapType();//设置AR地图的模式
...
public class MainActivity extends FragmentActivity  implements OnClickListener {
    ...
    //定位导航模块
    private LocationTencent mMyLocation = null;
    ...
    private void initLocate() {
        //腾讯定位
      //  mMyLocation = new LocationTencent(this);
    }
    /**
     * 需要申请的权限数组
     */
    ...
    private void initView() {
        ...
        findViewById(R.id.btn_ar2poi_mode).setOnClickListener(this);
        //滑动条
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.btn_unlimitedmap_mode://unlimited Pan the map
                ...
                break;
            case R.id.btn_ar2poi_mode:// 临近模式2  ，两种可供切换
                Intent intentOfAR = new Intent(this, StaticViewGeoObjectActivity.class);//显示intent
                startActivity(intentOfAR);
