...
//import base2.camera.CameraEventListener;
//import base2.camera.CameraPreferencesActivity;
//import base2.camera.CaptureCameraPreview;
//import base2.rendering.ARRenderer;
//import base2.rendering.gles20.ARRendererGLES20;
...
//        ///data/user/0/com.supermap.imobile.myapplication/cache
//        System.out.println("cachePath"+cachePath);
    ...
    public void onResume() {
        ...
        int nWidthPreView = 2000;
        int nHeightPreView = 1200;
//        // Add the views to the interface
        mainLayout.addView(preview, new LayoutParams(LayoutParams.FILL_PARENT, LayoutParams.FILL_PARENT)); //LayoutParams.FILL_PARENT
        mainLayout.addView(glView, new LayoutParams(LayoutParams.FILL_PARENT, LayoutParams.FILL_PARENT));
        {
            mapView = new MapView(this); //getApplicationContext()  //context
            mapControl = mapView.getMapControl(); //mapControl.setMapOverlay(true);
            mapView.addOverlayMap(mapControl);
            mainLayout.addView(mapView); //this.addView(mapView);
        }
...
//        ViewGroup.LayoutParams layoutParamsSur = surfaceView.getLayoutParams();
//        WindowManager wm = (WindowManager)getContext().getSystemService(Context.WINDOW_SERVICE);
//        int screenWidth = wm.getDefaultDisplay().getWidth();
//        layoutParamsSur.width = screenWidth;
//        surfaceView.setLayoutParams(layoutParamsSur);
//        mapControl.setMapOverlay(true);
        mapView.addOverlayMap(mapControl);
        if(!mapControl.getMap().IsArmap())
        {
            mapControl.getMap().setIsArmap(true);
        }
        mapControl.getMap().setSlantAngle(0); //40
        Point2D centerPoint = mapControl.getMap().getCenter();
        this.setViewPoint(centerPoint);
        mapControl.getMap().refresh();
        mIsArMode = true;
        bWorking = false;
    }

    boolean bFollowingMode = false;
    /**
     *
     */
    public void openFollowingMode(){
        ...
        mapView.removeOverlayMap(mapControl);
        mapControl.setMapOverlay(false);
//        ViewGroup.LayoutParams layoutParamsSur = surfaceView.getLayoutParams();
//        WindowManager wm = (WindowManager)getContext().getSystemService(Context.WINDOW_SERVICE);
//        int screenWidth = wm.getDefaultDisplay().getWidth();
//        layoutParamsSur.width = screenWidth;
//        surfaceView.setLayoutParams(layoutParamsSur);
        ...
        if (mapControl.getMap().IsArmap())
        {
            mapControl.getMap().setIsArmap(false);
        }
        //mapControl.getMap().SetSlantAngle(35);
        mIsArMode = false;
        bWorking = false;
    }
    /**
...
//        mapControl.setMapOverlay(false);
//        ViewGroup.LayoutParams layoutParamsSur = surfaceView.getLayoutParams();
//        layoutParamsSur.width = 1;
//        surfaceView.setLayoutParams(layoutParamsSur);
//        if (mapControl.getMap().IsArmap())
//        {
//            mapControl.getMap().setIsArmap(false);
//        }
//        mapControl.getMap().SetSlantAngle(0);
//        mIsArMode = false;
//        bWorking = false;
    }
    ...
    {
        mapControl.getMap().setCenter(point);
    }
